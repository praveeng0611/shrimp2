(function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://137.117.82.58:8000/api/v0/database/feed',
                headers: {
...
$(document).ready(function() {
    $('#searchFeedData').click(function(e) {
        e.preventDefault();
        ...
        $.LoadingOverlay("show");
        $.getJSON('http://137.117.82.58:8000/api/v0/database/feed/' + searchField, function(data) {
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <p class="form-control-static"> ${data.feed._id} </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <p class="form-control-static"> ${data.feed.name} </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <p class="form-control-static"> ${data.feed.companyName} </p>
                                </div>
                            </div>
                        </div>
                    </div>
