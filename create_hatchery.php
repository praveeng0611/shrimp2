<?php
    $__title = 'TATA SHRIMP PILOT | Create Hatchery';
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="col-md-9">
                                                        <input type="text" id="search" class="form-control" id="phtcerti_id"
                                                            name="phtCertificateId" placeholder="Enter Hatchery ID"
                                                            required>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <center><button type="submit" class="btn green btn_btn" id="searchHatcheryData">Search</button></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_0">
                                    <div class="portlet light ">
                                        <div class="portlet-body form">
                                            <h1 class="page-title"> Register New Hatchery</h1>
                                            <!-- BEGIN FORM-->
                                            <form class="form-horizontal" id="addhatchery" name="addprocessor" method="POST">
                                                <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" id="region"
                                                                        name="region" required="" placeholder="Indian"
                                                                        disabled="">
                                                                </div>
                                                            </div>
                                                        </div>
