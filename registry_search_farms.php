<?php
    $__title = 'TATA SHRIMP PILOT | Search Farms';
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="col-md-9">
                                                    <input type="text" id="search" class="form-control" name="phtCertificateId" placeholder="Enter Farm ID" required>
                                                </div>
                                                <div class="col-md-3">
                                ...
                                <div class="tab-pane active" id="tab_0">
                                    <div class="portlet light ">
                                        <div class="portlet-body form" id="result">
                                            <h1 class="page-title">Farm Details</h1>
                                            <!-- BEGIN FORM-->
