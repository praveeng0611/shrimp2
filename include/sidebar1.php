...
<div class="page-sidebar-wrapper">
            <div class="page-sidebar navbar-collapse collapse">
                <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    <script>
                        document.write('<li class="nav-item"><a href="dashboard.php" class="nav-link nav-toggle"><i class="icon-home"></i><span class="title">Dashboard</span></a></li>');
                        </script>
                    <li class="nav-item active">
                        ...
                        <ul class="sub-menu">
                            <script>
                                document.write('<li class="nav-item active"><a href="farm_create_harvest.html" class="nav-link "><span class="title">Create New Harvest</span></a></li>');
                                </script>
                            <script>
