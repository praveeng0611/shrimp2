            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li class="nav-item  ">
                        ...
                        <ul class="sub-menu">
                            <script>
                                document.write('<li class="nav-item  "><a href="registry_create_farm_with_pht.html" class="nav-link "><span class="title">Register Farm</span></a></li>');
                            </script>
                            <!-- <script>
                    ...
                    <!-- <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <script>
                                          document.write('<li class="nav-item  "><a href="create-farm.html?login='+ param +'" class="nav-link "><span class="title">Feed Supplier</span></a></li>');
                                        </script>
                    ...
                    <!-- <script>
                                  document.write('<li class="nav-item  "><a href="harvest_sell_to_processor.html?login='+ param +'" class="nav-link "><span class="title">Sell to Processor</span></a></li>');
                                </script>
                                <script>
                                  document.write('<li class="nav-item  "><a href="harvest_sell_to_processor.html?login='+ param +'" class="nav-link "><span class="title">Processor Pending Purchase</span></a></li>');
                                </script>
                                <script>
                                  document.write('<li class="nav-item  "><a href="harvest_sell_to_processor.html?login='+ param +'" class="nav-link "><span class="title">Processor Inventory Processing</span></a></li>');
                                </script>
                                <script>
                                  document.write('<li class="nav-item  "><a href="harvest_sell_to_processor.html?login='+ param +'" class="nav-link "><span class="title">Processor Inventory Processing Pending</span></a></li>');
                                </script> -->
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
